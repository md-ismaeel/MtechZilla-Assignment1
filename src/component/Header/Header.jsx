  ...
  return (
    <header className="flex justify-between items-center p-7">
      ...
      <div
        ...
        className="cursor-pointer relative inline-flex items-center justify-start py-3 pl-4 pr-12 overflow-hidden font-semibold text-[#3498DB] transition-all duration-150 ease-in-out rounded hover:pl-10 hover:pr-6 bg-slate-400 group"
      >
